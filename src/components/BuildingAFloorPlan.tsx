...
interface BuildingAFloorPlanProps {
  onApartmentClick: (apartment: string) => void;
  selectedApartment: string | null;
}

const BuildingAFloorPlan: React.FC<BuildingAFloorPlanProps> = ({
  onApartmentClick,
  selectedApartment,
}) => {
  const apartments = ['A1', 'A2', 'A3', 'A4', 'A5', 'A6'];
      ...
      <Grid container spacing={2}>
        {apartments.map((apt) => (
          ...
          >
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}floor-plans/building-a/${apt}.jpg`}
...
export default BuildingAFloorPlan;
