...
interface BuildingDFloorPlanProps {
  onApartmentClick: (apartment: string) => void;
  selectedApartment: string | null;
}

const BuildingDFloorPlan: React.FC<BuildingDFloorPlanProps> = ({
  onApartmentClick,
  selectedApartment,
}) => {
  const apartments = ['D1', 'D2', 'D3', 'D4', 'D5'];
      ...
      <Grid container spacing={2}>
        {apartments.map((apt) => (
          ...
          >
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}floor-plans/building-d/${apt}.jpg`}
...
export default BuildingDFloorPlan; 